...
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.ASSEMBLY;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.CLUSTER;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.CONTEXT;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.CREDENTIAL;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.CUBE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.CUBE_BUILD_PROCESS;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.CUBE_DIMENSION;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.DATABASE_DESTINATION;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.DATABASE_LINK;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.DIMENSION;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.DOMAIN_INDEX;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.DOMAIN_INDEX_TYPE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.EVALUATION_CONTEXT;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.FILE_GROUP;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.FILE_WATCHER;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.FUNCTION;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.INDEX;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.JAVA_CLASS;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.JAVA_DATA;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.JAVA_RESOURCE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.JAVA_SOURCE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.LIBRARY;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.MATERIALIZED_VIEW;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.MATERIALIZED_VIEW_LOG;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.MEASURE_FOLDER;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.MINING_MODEL;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.OPERATOR;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.PACKAGE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.PACKAGE_BODY;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.PROCEDURE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.QUEUE_TABLE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.REWRITE_EQUIVALENCE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.RULE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.RULE_SET;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.SCHEDULE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.SCHEDULER_CHAIN;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.SCHEDULER_GROUP;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.SCHEDULER_JOB;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.SCHEDULER_PROGRAM;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.SEQUENCE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.SQL_TRANSLATION_PROFILE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.SYNONYM;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.TABLE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.TRIGGER;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.TYPE;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.VIEW;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.XML_SCHEMA;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.getObjectTypeNames;
import static com.github.mengweijin.flyway.database.gbase.GbaseSchema.ObjectType.supportedTypesExist;

/**
 * @author mengweijin
 * @since 2024/9/28
 */
public class GbaseSchema extends Schema<GbaseDatabase, GbaseTable> {

    private static final Log LOG = LogFactory.getLog(GbaseSchema.class);
     ...
     */
    GbaseSchema(JdbcTemplate jdbcTemplate, GbaseDatabase database, String name) {
    ...
    protected void doClean() throws SQLException {
        ...
        List<GbaseSchema.ObjectType> objectTypesToClean = Arrays.asList(
                // Types to drop.
                TRIGGER,
                QUEUE_TABLE,
                FILE_WATCHER,
        ...
        for (GbaseSchema.ObjectType objectType : objectTypesToClean) {
    ...
    @Override
    protected GbaseTable[] doAllTables() throws SQLException {
        List<String> tableNames = TABLE.getObjectNames(jdbcTemplate, database, this);

        GbaseTable[] tables = new GbaseTable[tableNames.size()];
        for (int i = 0; i < tableNames.size(); i++) {
            tables[i] = new GbaseTable(jdbcTemplate, database, this, tableNames.get(i));
        }
        return tables;
    }
    ...
    public Table getTable(String tableName) {
        return new GbaseTable(jdbcTemplate, database, this, tableName);
    }
    ...
    public enum ObjectType {
        ...
        TABLE("TABLE", "CASCADE CONSTRAINTS PURGE") {
            @Override
            public List<String> getObjectNames(JdbcTemplate jdbcTemplate, GbaseDatabase database, GbaseSchema schema) throws SQLException {
        ...
        QUEUE_TABLE("QUEUE TABLE") {
            ...
            @Override
            public String generateDropStatement(JdbcTemplate jdbcTemplate, GbaseDatabase database, GbaseSchema schema, String objectName) {
        ...
        DATABASE_LINK("DATABASE LINK") {
            @Override
            public void dropObjects(JdbcTemplate jdbcTemplate, GbaseDatabase database, GbaseSchema schema) {
         ...
         */
        public void dropObjects(JdbcTemplate jdbcTemplate, GbaseDatabase database, GbaseSchema schema) throws SQLException {
         ...
         */
        public static Set<String> getObjectTypeNames(JdbcTemplate jdbcTemplate, GbaseDatabase database, GbaseSchema schema) throws SQLException {
            boolean xmlDbAvailable = database.isXmlDbAvailable();
         ...
         * @throws SQLException if retrieving of object types failed.
         */
        public static boolean supportedTypesExist(JdbcTemplate jdbcTemplate, GbaseDatabase database, GbaseSchema schema) throws SQLException {
