 ...
 * @since 2024/9/28
 */
public class GbaseDatabase extends Database<GbaseConnection> {
    ...
    public GbaseDatabase(Configuration configuration, JdbcConnectionFactory jdbcConnectionFactory, StatementInterceptor statementInterceptor) {
        super(configuration, jdbcConnectionFactory, statementInterceptor);
    }

    @Override
    protected GbaseConnection doGetConnection(Connection connection) {
        return new GbaseConnection(this, connection);
    }
