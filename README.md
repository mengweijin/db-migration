...
| db-migration 版本 | flyway 版本 |    liquibase 版本 |
|:------------------|------------:|------------------:|
| 4.0.0             |   12.4.0 ✅ | 4.27.0 ~ 5.0.3 ✅ |
...
- Spring boot 4 + db-migration V4 参考：[Spring boot 4 + db-migration V4](docs/use_db-migration_v4.md)
